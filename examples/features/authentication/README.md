...
[`credentials.PerRPCCredentials`](https://godoc.org/github.com/AmirSoleimani/grpc-go/credentials#PerRPCCredentials).
...
https://godoc.org/github.com/AmirSoleimani/grpc-go/credentials/oauth for details.

#### Client

On client side, users should first get a valid oauth token, and then call
[`credentials.NewOauthAccess`](https://godoc.org/github.com/AmirSoleimani/grpc-go/credentials/oauth#NewOauthAccess)
...
[`metadata.FromIncomingContext`](https://godoc.org/github.com/AmirSoleimani/grpc-go/metadata#FromIncomingContext)
